...
For [COVID-19 Knowledge Graph use-case](https://github.com/cansyl/CROssBAR/tree/master/COVID-19_KGs) please refer to the corresponding section below, for the manually constructed prototype hepatocellular carcinoma (HCC) network please visit [CROssBAR HCC network folder](https://github.com/cansyl/CROssBAR/tree/master/Prototype_HCC_Network).
