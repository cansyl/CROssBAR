		...
		<div class="col-md-9 mt-3">
			<div class="row" id="crossbar">
				...
				<p class="mt-2 custom_paragraph">
					<a href="https://www.biorxiv.org/content/10.1101/2020.09.14.296889v1" target=_blank>(Detailed information can be obtained from CROssBAR pre-print)</a></br>
The term knowledge graph defines a specialized data representation approach, in which collections of entities are linked to each other in a semantic context. In CROssBAR knowledge graphs, biological entities/terms are represented as vertices/nodes. Distinct types of nodes are defined for:
				</p>
				<p class="col-12">
					<ul class="custom_paragraph">					
						<li>biomolecules (i.e., genes and proteins),</li>
						<li>biological mechanisms (i.e., processes/pathways),</li>
						<li>pathologies (i.e., diseases),</li>
						<li>phenotypes (i.e., abnormalities, symptoms, etc.), and</li>
						<li>molecules used for treatment (i.e., drugs and drug candidate compounds).</li>
					</ul>
				</p>
				<p class="row col-12 custom_paragraph">
Relationships between same and different types of biological entities are expressed by the edges of the graph. Types of edges vary according to the defined relationship. The edge label for a relationship between:
				</p>
				<p class="col-12">
				<ul class="custom_paragraph">
					<li>two proteins: "interacts with",</li>
					<li>a gene/protein and a disease: "is raleted to",</li>
					<li>a drug/compound and a protein: "targets",</li>
					<li>a gene/protein and a pathway: "is involved in",</li>
					<li>a gene/protein and a phenotype term:"is associated with",</li>
					<li>a drug and a disease: "indicates",</li>
					<li>a disease and a pathway: "modulates", and </li>
					<li>a disease and a phenotype term: "is associated with".</li>
				</ul>
				</p>				
			</div>
			...
			<div class="row" id="example">
				...
				<figure class="figure col-6">
				  ...
				  <a href="images/example.png" target=_blank>
				  <img src="images/example.png" class="figure-img img-fluid rounded" alt="An Example CROssBAR Knowledge Graph"/>
				  </a>
				</figure>
				</p>
...
housed at EMBL-EBI servers and communicated via a public RESTful API service at <a href="https://www.ebi.ac.uk/Tools/crossbar/swagger-ui.html" target=_blank>https://www.ebi.ac.uk/Tools/crossbar/swagger-ui.html</a>. CROssBAR database comprises carefully selected features from various biomedical data sources namely UniProt, IntAct, InterPro,
...
schema is provided below.
			...
			<p class="row col-12 mt-3" id="">
				<figure class="figure col-6">
				  ...
				  <img src="images/schema.png" class="figure-img img-fluid rounded" alt="Schematic representation of the CROssBAR noSQL database"/>
				  </a>
				</figure>
			</p>
