...
<div class="p-0 mt-2">
	...
	<li class="list-group-item">Job ID: <b>Covid-19</b></li>
	</ul>
</div>
...
<div class="mt-2">
	...
	<div class="row border border-secondary mt-0 p-0">
		...
		<a id="data_json_file" href="covid19/largescale_covid19_network_data.json" target=_blank class="btn btn-sm btn-info btn-block">Download KG as a network (JSON)</a>
		</div>
	</div>
</div>
