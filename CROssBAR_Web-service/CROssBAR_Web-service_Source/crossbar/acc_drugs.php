	...
	foreach($drug_entities->drugs as $drug){
		...
		if($chembl){
			...
			if($drug->chembl_id !== null){
				...
				$chembl_accs_of_drug =  array_diff( chembl_id_to_acc($drug->chembl_id,$num_of_nodes) , $accs_of_this_drug);
